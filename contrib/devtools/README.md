...
Provides utilities for managing copyright headers of `The Agenor
...
---------------------------------------------------------
Updates all the copyright headers of `The AgenorCoin developers` which were
...
------------------------------------
Inserts a copyright header for `The AgenorCoin developers` at the top of the
...
If the file already has a copyright for `The AgenorCoin developers`, the
script will exit.
...
Setup
---------
Configuring the github-merge tool for the Agenor repository is done in the following way:
...
A script to optimize png files in the Agenor
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_agenor: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_agenor: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_agenor: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_agenor: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
