...
RESOURCES += src/qt/agenor.qrc src/qt/agenor_locale.qrc

TRANSLATIONS += src/qt/locale/agenor_bg.ts \
                src/qt/locale/agenor_de.ts \
                src/qt/locale/agenor_en.ts \
                src/qt/locale/agenor_es.ts \
                src/qt/locale/agenor_fi.ts \
                src/qt/locale/agenor_fr.ts \
                src/qt/locale/agenor_it.ts \
                src/qt/locale/agenor_ja.ts \
                src/qt/locale/agenor_pl.ts \
                src/qt/locale/agenor_pt.ts \
                src/qt/locale/agenor_ru.ts \
                src/qt/locale/agenor_sk.ts \
                src/qt/locale/agenor_sv.ts \
                src/qt/locale/agenor_vi.ts \
                src/qt/locale/agenor_zh_CN.ts \
                src/qt/locale/agenor_zh_TW.ts
