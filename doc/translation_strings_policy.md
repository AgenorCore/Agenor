...
This document provides guidelines for internationalization of the Agenor Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `agenor_en.ts` remains unchanged.
