...
1. Clone the Agenor Core source code:

        git clone https://github.com/AgenorCore/AGENOR
        cd agenor
...
Agenor Core is now available at `./src/agenord`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/PIVX"

    touch "/Users/${USER}/Library/Application Support/PIVX/agenor.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/PIVX/agenor.conf"

The first time you run agenord, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/agenord -daemon # Starts the agenor daemon.
    ./src/agenor-cli --help # Outputs a list of command-line options.
    ./src/agenor-cli help # Outputs a list of RPC commands when the daemon is running.
