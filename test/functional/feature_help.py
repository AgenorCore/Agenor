...
"""Verify that starting agenor with -h works as expected."""
import subprocess

from test_framework.test_framework import AgenorCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(AgenorCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start agenor with -? for help text")
        ...
        self.log.info("Start agenor with -version for version information")
