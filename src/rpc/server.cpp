...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIVX features */
        {"agenor", "listmasternodes", &listmasternodes, true },
        {"agenor", "getmasternodecount", &getmasternodecount, true },
        {"agenor", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"agenor", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"agenor", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"agenor", "masternodecurrent", &masternodecurrent, true },
        {"agenor", "startmasternode", &startmasternode, true },
        {"agenor", "createmasternodekey", &createmasternodekey, true },
        {"agenor", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"agenor", "listmasternodeconf", &listmasternodeconf, true },
        {"agenor", "getmasternodestatus", &getmasternodestatus, true },
        {"agenor", "getmasternodewinners", &getmasternodewinners, true },
        {"agenor", "getmasternodescores", &getmasternodescores, true },
        {"agenor", "preparebudget", &preparebudget, true },
        {"agenor", "submitbudget", &submitbudget, true },
        {"agenor", "mnbudgetvote", &mnbudgetvote, true },
        {"agenor", "getbudgetvotes", &getbudgetvotes, true },
        {"agenor", "getnextsuperblock", &getnextsuperblock, true },
        {"agenor", "getbudgetprojection", &getbudgetprojection, true },
        {"agenor", "getbudgetinfo", &getbudgetinfo, true },
        {"agenor", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"agenor", "mnfinalbudget", &mnfinalbudget, true },
        {"agenor", "checkbudgets", &checkbudgets, true },
        {"agenor", "mnsync", &mnsync, true },
        {"agenor", "spork", &spork, true },
...
{
    return "> agenor-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:32051/\n";
}
