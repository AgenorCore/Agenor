...
extern UniValue setzagenoreed(const JSONRPCRequest& request);
extern UniValue getzagenoreed(const JSONRPCRequest& request);
extern UniValue generatemintlist(const JSONRPCRequest& request);
extern UniValue searchdzage(const JSONRPCRequest& request);
extern UniValue dzagenortate(const JSONRPCRequest& request);
