...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("AgenorCoin Core agenor-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  agenor-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded agenor transaction") + "\n" +
                               "  agenor-tx [options] -create [commands]   " + _("Create hex-encoded agenor transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded agenor transaction
