...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(AGE);
    unitlist.append(mAGE);
    unitlist.append(uAGE);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case AGE:
        return QString("agenor");
    case mAGE:
        return QString("magenor");
    case uAGE:
        return QString::fromUtf8("uagenor");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZage)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZAGE)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZAGE);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZAGE)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZAGE));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
