...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            AgenorGUI* window = static_cast<AgenorGUI*>(parentWidget());
...
{
    AgenorGUI* gui = static_cast<AgenorGUI*>(parentWidget());
...
{
    hide();
    static_cast<AgenorGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Agenor will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your AGEs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
