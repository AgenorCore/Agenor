...
#include "qt/agenor/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/agenor/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(AgenorGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableAGE,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableAGE,
    ...
    connect(ui->pushButton_UnspendableAGE, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableAGE);});
    ...
    if (parent)
        connect(parent, &AgenorGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
