...
#include "qt/agenor/settings/settingsconsolewidget.h"
#include "qt/agenor/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/agenor/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(AgenorGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Agenor RPC console.") + "<br>" +
