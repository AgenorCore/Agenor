...
#include "qt/agenor/settings/settingsbittoolwidget.h"
#include "qt/agenor/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(AgenorGUI* _window, QWidget *parent) :
