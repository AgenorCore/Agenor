...
#include "qt/agenor/settings/settingswalletrepairwidget.h"
#include "qt/agenor/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/agenor/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(AgenorGUI* _window, QWidget *parent) :
