...
#include "qt/agenor/sendcustomfeedialog.h"
#include "qt/agenor/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(AgenorGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &AgenorGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
