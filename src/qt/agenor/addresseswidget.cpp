...
#include "qt/agenor/forms/ui_addresseswidget.h"
#include "qt/agenor/addresslabelrow.h"
#include "qt/agenor/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(AgenorGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination ageAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(ageAdd, label.toUtf8().constData(),
