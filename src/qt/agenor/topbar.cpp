...
#include "qt/agenor/forms/ui_topbar.h"
#include "qt/agenor/lockunlock.h"
#include "qt/agenor/qtutils.h"
#include "qt/agenor/receivedialog.h"
#include "qt/agenor/loadingdialog.h"
...
TopBar::TopBar(AgenorGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopAge}, "amount-small-topbar");
    setCssProperty({ui->labelAmountAge}, "amount-topbar");
    setCssProperty({ui->labelPendingAge, ui->labelImmatureAge}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // PIV Total
    QString totalAge = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);

    // PIV
    // Top
    ui->labelAmountTopAge->setText(totalAge);
    // Expanded
    ui->labelAmountAge->setText(totalAge);
    ui->labelPendingAge->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance, nDisplayUnit));
    ui->labelImmatureAge->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
