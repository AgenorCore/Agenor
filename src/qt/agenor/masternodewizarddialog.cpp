...
#include "qt/agenor/forms/ui_masternodewizarddialog.h"

#include "activemasternode.h"
#include "optionsmodel.h"
#include "pairresult.h"
#include "qt/agenor/mnmodel.h"
    ...
    walletModel(model)
{
    ...
    if (walletModel->isRegTestNetwork()) {
        ui->lineEditPort->setText("42058");
    } else if (walletModel->isTestNetwork()) {
        ui->lineEditPort->setText("42052");
    } else {
        ui->lineEditPort->setText("31052");
    }
