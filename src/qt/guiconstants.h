...
/* AgenorCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Agenor"
#define QAPP_ORG_DOMAIN "agenor.org"
#define QAPP_APP_NAME_DEFAULT "Agenor-Qt"
#define QAPP_APP_NAME_TESTNET "Agenor-Qt-testnet"
